...
$(document).ready(function() {
    ...
    $("#expressionproblems").append("<li><a href='/csedresearch/public/expressions/expressions.html' class='topnav_expressions' title='Problem 1'>Problem 1</a></li>");

    $("#ifelse").append("<ul id='ifelseproblems'>");
    $("#ifelseproblems").append("<li><a href='/csedresearch/public/if_else/index.html' class='topnav_ifelse' title='Problem 1'>Problem 1</a></li>");

    $("#arraymystery").append("<ul id='arrayproblems'>");
    $("#arrayproblems").append("<li><a href='/csedresearch/public/arrayMystery/index.html' class='topnav_array' title='Problem 1'>Problem 1</a></li>");
});
(function($) {
